...
fon = transform.scale(image.load("=-88.jpg"),(500,500))
plat = Player('=-77.png', 5, win_width - 80,4) 
plat2 = Player('=-77.png', 435, win_width - 80,4) 

smert = transform.scale(image.load("00978.png"),(250,500))

mach = transform.scale(image.load("=-99.png"),(80,80)) 
